...
Create free account → New Project → Create Cluster (M0 Free)
...
Replace <password> in your .env MONGODB_URI
...
Deploy → Copy your Render URL (e.g. https://your-app.onrender.com)
...
Import GitHub repo OR drag-and-drop your folder
